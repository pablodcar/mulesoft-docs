...
. If you don't already have one, create a link:http://twitter.com/signup[regular Twitter account]. You may wish to create an account specifically for testing for posting things to Twitter in this exercise. 
...
|*Website* |An entry is required here, however, because this Twitter application is not public, this field is not meaningful; enter a simple placeholder value.
...
|*link:https://www.mulesoft.com/exchange#!/twitter-integration-connector[Twitter Connector]* |Enables you to perform operations against one or more Twitter resources. Find this in the Connectors section of the palette.
...
* Learn how to create your own Anypoint Connectors using the link:/anypoint-connector-devkit/v/3.8[Anypoint Connector DevKit].
