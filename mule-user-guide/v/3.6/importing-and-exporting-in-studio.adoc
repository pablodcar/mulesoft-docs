...
|*Publish to Application Repository* |Publish your project to the link:/mule-management-console/v/3.6/mmc-walkthrough[Mule Management Console] application repository.
|===
...
* Explore a few link:/mule-fundamentals/v/3.6/anypoint-exchange[example applications] in Anypoint Studio.
