...
* Follow the link:/anypoint-platform-for-apis/apikit-tutorial[APIkit Tutorial] to publish a sample RAML-based API.  
...
If either or both of these describes your use case, visit the link:/anypoint-connector-devkit/v/3.8[DevKit] documentation to learn more about the process of building a connector.

==== Get Started:

* link:/mule-user-guide/v/3.6/consuming-a-rest-api[Consuming REST APIs] with HTTP
* Build a connector with link:/anypoint-connector-devkit/v/3.8[Anypoint Connector DevKit]
