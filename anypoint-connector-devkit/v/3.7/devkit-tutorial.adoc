...
For information on setup and DevKit, see link:/anypoint-connector-devkit/v/3.7/setting-up-your-dev-environment[Setting Up Your Development Environment] and link:/anypoint-connector-devkit/v/3.7/index[Anypoint Connector DevKit].
...
+
. Run the link:/anypoint-connector-devkit/v/3.7/creating-a-java-sdk-based-connector#generating-sources[Generate Sources] Action.
+
...
* The full link:/anypoint-connector-devkit/v/3.7/developing-devkit-connector-tests[testing documentation].
...
* link:/anypoint-connector-devkit/v/3.7/authentication[Authentication][DevKit Authentication] documentation.
...
* link:/anypoint-connector-devkit/v/3.7/adding-query-pagination-support[Adding Query Pagination Support][Adding Pagination Support].
...
* link:/anypoint-connector-devkit/v/3.7/authentication[Authentication] documentation.
