...
The *SOAP Connect* wizard generates a WSDL-based connector that receives and responds in XML elements. This kind of connector only runs on Mule versions 3.7 or above. 
