...
* Installed the Anypoint Connector DevKit Plugin as described in  link:/anypoint-connector-devkit/v/3.7/creating-an-anypoint-connector-project[Creating an Anypoint Connector Project]
...
// Write functional tests using the link:https://github.com/mulesoft-labs/connector-testing-framework/tree/master/functional-test-framework[current connector testing framework].
...
After you complete your test suite, you can  link:/anypoint-connector-devkit/v/3.7/connector-reference-documentation[generate complete documentation and samples] for your connector.
