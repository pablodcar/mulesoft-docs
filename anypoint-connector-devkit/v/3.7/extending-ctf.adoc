...
Using a simple Maven command from the connector's root folder, you can perform tests on the connector in the runtime specified in your *local profile*, *embedded runtime* or an *availabe CloudHub runtime* version.
