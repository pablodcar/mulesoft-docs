...
. _New Connector:_ 
* link:/anypoint-connector-devkit/v/3.8/creating-a-java-sdk-based-connector[Create an Anypoint project] - Set up Anypoint Studio and install the connector plugin. 
...
|link:/anypoint-connector-devkit/v/3.8/anypoint-connector-examples[Examples] a|
