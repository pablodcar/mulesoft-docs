...
//todo: make sub-item of https://docs.mulesoft.com/anypoint-connector-devkit/v/3.7/creating-a-soap-connector#coding-with-wsdlprovider ?
...
== See Also
Recall the basics of metadata retrieval from link:/anypoint-connector-devkit/v/3.7/adding-datasense#metadata-retrieval[here]
